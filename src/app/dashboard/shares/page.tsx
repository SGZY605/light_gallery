  ...
  return (
    <div className="space-y-8">
      <section className="rounded-[32px] border border-slate-200 bg-white p-7 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-slate-400">Shares</p>
        <h2 className="mt-3 text-3xl font-semibold text-slate-950">Publish filtered public galleries without duplicating image metadata.</h2>
      ...
      <section className="rounded-[32px] border border-slate-200 bg-white p-7 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        <div className="max-w-3xl">
          ...
          <h3 className="mt-2 text-2xl font-semibold text-slate-950">Select the tags that define the public view.</h3>
        </div>
        ...
        <form action={createShareAction} className="mt-6 grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <span className="text-sm font-medium text-slate-700">Tag filter</span>
      ...
      <section className="rounded-[32px] border border-slate-200 bg-white p-7 shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        <div className="border-b border-slate-200 pb-4">
          <p className="text-xs font-semibold uppercase tracking-[0.32em] text-slate-400">Share Links</p>
          <h3 className="mt-2 text-2xl font-semibold text-slate-950">Active, expired, and revoked links</h3>
        </div>
